...
class TestHomeView(unittest.TestCase):
	...
	type(mget.return_value).content = PropertyMock(return_value = sample_image)
	type(mget.return_value).headers = PropertyMock(return_value = {'content-type': 'image/jpeg'})
	...
	sample_text = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
        ...
        type(mget.return_value).content = PropertyMock(return_value = sample_text)
        type(mget.return_value).headers = PropertyMock(return_value = {'content-type': 'text/plain'})
